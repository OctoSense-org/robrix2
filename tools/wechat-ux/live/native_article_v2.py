...
def main():
    ...
    try:
        ...
        updates=find_event(lambda e:e.get('content',{}).get('m.relates_to',{}).get('event_id')==original['event_id'] and e.get('content',{}).get('org.octosense.article',{}).get('version')==2);assert len(updates)==1
